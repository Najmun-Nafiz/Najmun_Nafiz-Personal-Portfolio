        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="{{ route('admin.back') }}">
                <img class="brand-img d-inline-block" src="{{asset('front/images/logo.png')}}" style="height: 38px;width: 125px;" alt="brand" />
            </a>
                        ...
                        <div class="notifications-nicescroll-bar">
                                ...
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('back/dist/img/avatar1.jpg')}}" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="{{asset('back/dist/img/avatar2.jpg')}}" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div>
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="{{asset('back/dist/img/najmun.jpg')}}" alt="user" class="avatar-img rounded-circle">
                                </div>
