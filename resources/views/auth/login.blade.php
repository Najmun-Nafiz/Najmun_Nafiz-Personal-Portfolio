        ...
        <div class="hk-pg-wrapper hk-auth-wrapper">
            <header class="d-flex justify-content-between align-items-center">
                <a class="d-flex auth-brand" href="#">
                    <img class="brand-img" src="{{asset('back/dist/img/logo-dark.png')}}" alt="brand" />
                </a>
                ...
                <div class="row">
                    <div class="col-xl-5 pa-0">
                        <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(back/dist/img/bg2.jpg);">
                            ...
                            <div class="fadeOut item auth-cover-img overlay-wrap" style="background-image:url(back/dist/img/bg1.jpg);">
                                <div class="auth-cover-info py-xl-0 pt-100 pb-50">
                                    <div class="auth-cover-content text-center w-xxl-75 w-sm-90 w-xs-100">
                        ...
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method="post" action="{{ route('login') }}">
                                    ...
                                    <a class="btn btn-danger btn-block" href="{{route('password.request')}}">Forget Password</a>
