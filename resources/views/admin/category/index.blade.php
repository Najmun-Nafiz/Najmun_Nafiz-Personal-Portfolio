        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Category Table</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Category Table</h5>
                                    ...
                                    <div class="table-wrap">
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                               ...
                                               @foreach($categories as $key=>$v_info)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if($v_info -> status == true)
                                                            <a href="{{ route('admin.category.unactive',$v_info->id) }}" style="background-color: red;padding: 4px 7px;margin-right: 5px; border-radius: 3px;">
                                                                <i class="glyphicon glyphicon-remove"></i>
                                                            </a>
                                                        @else
                                                            <a href="{{ route('admin.category.active',$v_info->id) }}" style="background-color: red;padding: 4px 7px;margin-right: 5px; border-radius: 3px;">
                                                                <i class="glyphicon glyphicon-ok"></i>
                                                            </a>
                                                        @endif

                                                        <a href="{{route('admin.category.edit',$v_info->id)}}" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
      
                                                        <a href="{{route('admin.category.destroy',$v_info->id)}}" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i></a>
