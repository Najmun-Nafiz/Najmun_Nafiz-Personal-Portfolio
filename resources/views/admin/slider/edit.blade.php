                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <form action="{{ route('admin.slider.update',$slider->id)}}" method = "post" enctype="multipart/form-data">
                                                ...
                                                <input type="text" class="form-control mt-15" placeholder="Name" name="name" value="{{ $slider -> name }}" required>
                                                <input type="text" class="form-control mt-15" placeholder="Carrear" name="carrear" value="{{ $slider -> carrear }}"  required>

                                                <textarea class="form-control mt-15" cols="10" rows="3" placeholder="Description" name="description"  required>{{ $slider -> description }}</textarea>
                                               
                                               <input type="file" name="image" class="form-control mt-15" value="{{ $slider -> image }}"  required>
